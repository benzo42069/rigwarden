...
- **Integrated:** `TOP-REG-001` (exact in-memory device/firmware profile resolution with explicit profile-derived write capability) after independent review and post-landing sweeps.
...
**Last completed integration sweep:** `TOP-REG-001` focused exact-profile test, registry/domain package tests, workspace formatter, and Clippy with warnings denied exited 0 after reviewed public source/evidence candidate commit `a24244cd849658f9758adbf86c7b505ec8b9bf65`.
